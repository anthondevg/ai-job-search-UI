...
export default function JobScraperMarket() {
  ...
  return (
    <div className="flex flex-1 flex-col p-4 sm:p-6 lg:p-8">
      ...
      <div className="flex min-h-[280px] flex-1 items-center justify-center rounded-xl border-2 border-dashed border-border bg-surface-raised p-6 sm:p-10 lg:p-12">
        <div className="text-center">
          <div className="mx-auto mb-4 flex size-14 items-center justify-center rounded-full bg-success-subtle text-success">
